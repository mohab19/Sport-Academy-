...
class NotificationsController extends Controller
{
    ...
    {
        foreach ($this->new_notifications as $new_notification)
        {
            $new_notification->read = 1;
            $new_notification->save();
        }
    }
    public function getCount()
    {
        return sizeof($this->new_notifications);
    }
    ...
    public function getFeed()
    {
        ...
        {
echo "<a href='$notification->url'><div class='notification"; if($notification->read == 0)echo" unread'>";else echo "'>'";
        if($notification->sender->picture)
        echo"<img src='{$notification->user->picture}' width='40' height='40' class='img-rounded'>";
                                else
                                   echo" <img src='$default_image' width='40' height='40' class='img-rounded'/>
                                <span class='dark-gray'><b>{$notification->sender->short_name}</b> $notification->title</span>
                        </div>
                        </a>";
        }
    }
