    ...
    protected function createTestHtml5Form()
    {
        ...
        <html>
            ...
            <form id="form_2" action="" method="POST">
                ...
                <div>
                    <label for="app_frontend_form_type_contact_form_type_fullname">Firstname</label>
                    <input type="text" name="app_frontend_form_type_contact_form_type[firstName]" value="John" id="app_frontend_form_type_contact_form_type_fullname"/>
                </div>
            </form>
            <button />
        </html>');
